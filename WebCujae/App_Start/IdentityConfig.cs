...
namespace WebCujae
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static void CreateAdminUser(IdentityRole role)
        {
            ...
            using (contexto)
            {
                var query = from us in contexto.Users
                ...
                if (result == null)
                {
                    manager.Create(user, "AdminPass44!");
                    manager.AddToRole(user.Id, role.Name);
                }
                else
                    manager.AddToRole(result.Id, role.Name);
            }
